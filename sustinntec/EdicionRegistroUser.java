...
public class EdicionRegistroUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_useredi);
...
//Recuperamos la información pasada en el intent
        ...
        final String nombres=  (bundle.getString("User"));
        txtVivi.setText(nombres);
        final String nombre = (String) txtVivi.getText();
        ...
        final ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    String uno = dataSnapshot.child("Viviendas").child("Prueba").child("apellidos").getValue().toString();
                    String dos = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("nombre").getValue().toString();
                    String tres = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("apellido paterno").getValue().toString();
                    String cuatro = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("apellido materno").getValue().toString();
                    String cinco = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("edad").getValue().toString();
                    String seis = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("correo").getValue().toString();
                    String siete = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("contraseña").getValue().toString();
                    String ocho = dataSnapshot.child("Viviendas").child("Prueba").child("Usuarios").child(nombre).child("teléfono").getValue().toString();
                    // String reg = txtContra.getText().toString();
                    txtViv.setText(uno);
                    txtNombre.setText(dos);
                    txtApellidoP.setText(tres);
                    txtApellidoM.setText(cuatro);
                    txtEdad.setText(cinco);
                    txtCorreo.setText(seis);
                    txtContra.setText(siete);
                    txtTele.setText(ocho);
                }
            }
...
//DecodeString(cor);
                ...
                if (TextUtils.isEmpty(cor)) {
                    ...
                    {
                        Toast.makeText(EdicionRegistroUser.this, "Por favor, introduce bien su email", Toast.LENGTH_LONG).show();
                    }
                ...
                Intent intent = new Intent(EdicionRegistroUser.this, Tipo.class);
    ...
    private void act(){
        ...
        DatabaseReference dbRef =
                FirebaseDatabase.getInstance().getReference()
                        .child("Viviendas").child("Prueba").child("Usuarios");
        ...
        Intent intent = new Intent(EdicionRegistroUser.this, Administrador.class);
        //Creamos la información a pasar entre actividades
        Bundle b = new Bundle();
    ...
    private void eli(){
        ...
        Query applesQuery = ref.child("Viviendas").child("Prueba").child("Usuarios").child(text);
