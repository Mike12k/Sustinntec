...
public class ListadoVen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listapv);
                    ...
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    if (dataSnapshot.exists()) {
                                        //Opcion 2
                                        String uno = dataSnapshot.child("Tecnologico de Matehuala").getKey().toString();
                                        String dos = dataSnapshot.child("Mercantil de la Rosa - Ferreteria").getKey().toString();
                                         String tres = dataSnapshot.child("Ferreteria Martinez").getKey().toString();
                                        // String cuatro = dataSnapshot.child("4").getValue().toString();
                                        // String cinco = dataSnapshot.child("5").getValue().toString();
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                String text = (String) lv1.getItemAtPosition(arg2);
                 txtRes.setText(text);
                Intent intent = new Intent(ListadoVen.this, NuevoPV.class);
                Bundle b = new Bundle();
                b.putString("Ven", txtRes.getText().toString());
