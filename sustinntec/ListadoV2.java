...
public class ListadoV2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNue.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(ListadoV2.this, Registro.class);
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                txtRes.setText(text);
                Intent intent = new Intent(ListadoV2.this, EdicionRegistro.class);
                Bundle b = new Bundle();
                b.putString("User", txtRes.getText().toString());
                b.putString("Viv", txtRes.getText().toString());
