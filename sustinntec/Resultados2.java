...
//Obtenemos las referencias a los controles
        ...
        btnDet.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Resultados2.this, Temperatura.class);
                Bundle b = new Bundle();
        ...
        btnTemp.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Resultados2.this, Proximidad.class);
                Bundle b = new Bundle();
                b.putString("Corr", txtResull.getText().toString());
                b.putString("Viv", txtResull2.getText().toString());
                //Añadimos la información al intent
        ...
        btnLit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Resultados2.this, Litros.class);
                Bundle b = new Bundle();
                b.putString("Corr", txtResull.getText().toString());
                b.putString("Viv", txtResull2.getText().toString());
                //Añadimos la información al intent
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            try {
                                ...
                                // aplicacion.
                                Bitmap bitmap = BitmapFactory.decodeResource(Resultados2.this.getResources(),
                                        R.drawable.log);
